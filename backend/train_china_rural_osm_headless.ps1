# China Rural OSM — headless SUMO (no GUI, faster for longer runs).
# 3 rounds x 500 steps x 6 nodes.
#
# Requirements: sumo on PATH or SUMO_HOME set.
# With GUI: .\train_china_rural_osm.ps1
...
Write-Host ""
Write-Host "===== China Rural OSM — AdaptFlow Headless =====" -ForegroundColor Cyan
Write-Host "  Nodes: 6  |  Rounds: 3  |  Steps: 500" -ForegroundColor Cyan
